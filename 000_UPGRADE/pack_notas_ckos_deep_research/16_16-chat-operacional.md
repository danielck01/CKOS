---
title: "16 - Chat Operacional"
area: "UX"
priority: "P0"
type: "deep-research-prompt"
project: "CKOS"
status: "draft"
tags: ["ckos", "chat", "commandbar", "ux"]
---
...
Projetar o chat central do CKOS como centro de comando, grupos, agentes, decisões, tarefas, aprovações e artefatos.
...
TAREFA:
Atue como UX lead de chat operacional AI-first. Crie o Deep Research da interface de chat do CKOS.

ENTREGUE:
1. Objetivo do chat.
2. Diferença entre chat comum e chat operacional.
3. Grupos e conversas diretas estilo WhatsApp.
4. Mensagens que viram:
   - subtarefa;
   - decisão;
   - aprovação;
   - artifact;
   - issue;
   - briefing update.
5. Status de agentes acima da commandbar.
6. Commandbar minimalista.
7. Drawer de conversas.
8. Pin, archive, unread filter e membros.
9. Detalhes do grupo: políticas, budgets, skills, tools.
10. Modelo de dados.
11. UI states.
12. Prompt de implementação.

REGRAS:
A commandbar e o dock são separados.
Não criar tela demo/auth antes da experiência.
O chat deve saber se há projeto ativo.
```

## Outputs esperados

- Spec Chat Operacional
- Modelo de dados
- Fluxos de ação
- Prompt UI
...
- Chat vira centro de execução
- Conecta conversa com objetos do sistema
- Não parece apenas WhatsApp com IA
...
- Não jogar tudo no chat sem estrutura
- Não repetir botões
- Não esconder projeto ativo

---
title: "12 - Knowledge Base por Projeto"
area: "Arquitetura de Conhecimento"
priority: "P0"
type: "deep-research-prompt"
project: "CKOS"
status: "draft"
tags: ["ckos", "knowledge", "rag", "memoria"]
---

# 12 - Knowledge Base por Projeto

## Objetivo

Definir a base de conhecimento por projeto, com arquivos, notas, decisões, contexto, referências e memória operacional.
...
TAREFA:
Atue como arquiteto de conhecimento, RAG e produto. Crie o Deep Research da Knowledge Base do CKOS.

ENTREGUE:
1. O que entra na Knowledge.
2. Tipos de fonte:
   - arquivos;
   - links;
   - notas;
   ...
   - referências;
   - stakeholders.
3. Como organizar por projeto.
4. Como evitar vazamento entre clientes.
5. Como agentes consultam conhecimento.
6. Como versionar conhecimento.
7. Como lidar com conteúdo antigo.
8. Como conectar com RAG/vector store.
9. UX da página Knowledge.
10. Modelo de dados.
11. Prompt de implementação.

REGRAS:
Knowledge não é só upload de arquivo.
É memória operacional do projeto.
```
...
- Permite agentes responderem com contexto real
- Evita confusão entre projetos
- Cria base para proposta, execução e suporte
...
- Não tratar Knowledge como drive comum
- Não ignorar versionamento

---
title: "15 - Sprints & Releases"
area: "Operação"
priority: "P1"
type: "deep-research-prompt"
project: "CKOS"
status: "draft"
tags: ["ckos", "sprints", "releases", "pmo"]
---
...
Organizar ciclos de execução, entregas, versões, marcos, changelog e aprendizado.
...
TAREFA:
Atue como PMO de produto e engenharia. Crie o Deep Research de Sprints & Releases do CKOS.

ENTREGUE:
1. Diferença entre sprint, release, marco e entrega.
2. Como criar sprint a partir de briefing/proposta.
3. Como agentes participam da sprint.
4. Como medir progresso.
5. Como registrar changelog.
6. Como conectar com ROI.
7. Como lidar com escopo novo.
8. Como exibir versão para cliente.
9. Modelo de dados.
10. UI Sprints & Releases.
11. Prompt de implementação.

REGRAS:
Sprints devem ser úteis para execução real, não ritual de metodologia.
```

## Outputs esperados

- Spec Sprints & Releases
- Fluxo de sprint
- Modelo de dados
- Prompt UI
...
- Ajuda a entregar ciclos claros
- Conecta execução com proposta
- Mostra evolução do projeto
...
- Não criar Scrum burocrático
- Não confundir sprint com lista de tarefas
- Não ignorar release notes

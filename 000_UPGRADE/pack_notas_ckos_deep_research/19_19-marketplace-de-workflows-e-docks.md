---
title: "19 - Marketplace de Workflows e Docks"
area: "Monetização"
priority: "P2"
type: "deep-research-prompt"
project: "CKOS"
status: "draft"
tags: ["ckos", "marketplace", "docks", "monetizacao"]
---

# 19 - Marketplace de Workflows e Docks

## Objetivo

Explorar marketplace de workflows, agentes, templates, docks, add-ons e revenue share.
...
TAREFA:
Atue como estrategista de plataforma e marketplace. Crie o Deep Research do marketplace do CKOS.

ENTREGUE:
1. O que pode ser vendido:
   - workflows;
   - templates;
   - agentes;
   - docks;
...
8. Riscos.
9. Como lançar sem complexidade no MVP.
10. Modelo de dados futuro.
11. UI Marketplace.
12. Prompt de implementação futura.

REGRAS:
Não colocar marketplace no núcleo do MVP se travar o produto.
Pensar como expansão estratégica.
```
...
- Mostra potencial de escala
- Não compromete MVP
- Conecta creators/sócios com monetização
...
- Não criar marketplace antes de ter produto utilizável
- Não vender workflow sem controle de qualidade
- Não ignorar suporte e reembolso

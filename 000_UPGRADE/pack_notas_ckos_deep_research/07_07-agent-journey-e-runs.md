---
title: "07 - Agent Journey e Runs"
area: "Multiagentes"
priority: "P0"
type: "deep-research-prompt"
project: "CKOS"
status: "draft"
tags: ["ckos", "agentes", "runs", "agent-journey"]
---

# 07 - Agent Journey e Runs

## Objetivo

Desenhar a jornada viva dos agentes, com estados, handoffs, logs, bloqueios, outputs e motivos de ativação.
...
TAREFA:
Atue como arquiteto de sistemas multiagentes e UX de transparência operacional. Crie o Deep Research da página Runs/Agent Journey do CKOS.

ENTREGUE:
1. O que é um run.
2. O que é uma agent journey.
3. Estados dos agentes:
   - analisando;
   - pensando;
   - editando;
   - criando;
...
6. Logs úteis versus logs técnicos.
7. Como mostrar progresso no chat e na página dedicada.
8. Modelo de dados.
9. Eventos.
10. UI premium estilo Manus, mas com identidade CK.
11. Prompt de implementação.

REGRAS:
Transparência sem poluição.
Mostrar razão, ação, output e próximo passo.
Não transformar em terminal técnico para cliente leigo.
```
...
- Estados de agentes
- Modelo de logs
- Prompt UI de timeline

## Critérios de aceitação

- Usuário entende o que os agentes estão fazendo
- Permite auditoria e confiança
- Conecta runs com decisões, tarefas e custos
...
- Não mostrar log técnico cru como experiência principal

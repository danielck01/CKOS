---
title: "01 N8N como Acelerador nao Core"
tipo: "engenharia_de_prompt_n8n"
area: "n8n, automação, CKOS"
status: "draft"
json_workflow: "./01_N8N_como_Acelerador_nao_Core.json"
relacionado:
  - "../../../00_DigitalOcean_PMO/01_Decisao_PMO_Iniciar_com_DigitalOcean.md"
  - "../../../03_Policies/02_Policy_N8N_Prototipo_para_Codigo.md"
---

# 01 N8N como Acelerador nao Core

## Objetivo

Definir o papel do n8n como acelerador, não core crítico.
...
```json
{
  ...
  "workflow": "01_N8N_como_Acelerador_nao_Core",
  "project_id": "uuid",
  "result": {},
  "audit_log_id": "uuid"
}
...
Ver arquivo: `01_N8N_como_Acelerador_nao_Core.json`

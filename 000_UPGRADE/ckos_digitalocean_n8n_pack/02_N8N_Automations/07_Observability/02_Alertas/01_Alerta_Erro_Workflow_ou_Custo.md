---
title: "01 Alerta Erro Workflow ou Custo"
tipo: "engenharia_de_prompt_n8n"
area: "n8n, automação, CKOS"
status: "draft"
json_workflow: "./01_Alerta_Erro_Workflow_ou_Custo.json"
relacionado:
  - "../../../00_DigitalOcean_PMO/01_Decisao_PMO_Iniciar_com_DigitalOcean.md"
  - "../../../03_Policies/02_Policy_N8N_Prototipo_para_Codigo.md"
---

# 01 Alerta Erro Workflow ou Custo

## Objetivo

Notificar erro recorrente, custo alto ou falha de workflow.
...
```json
{
  ...
  "workflow": "01_Alerta_Erro_Workflow_ou_Custo",
  "project_id": "uuid",
  "result": {},
  "audit_log_id": "uuid"
}
...
Ver arquivo: `01_Alerta_Erro_Workflow_ou_Custo.json`

---
title: "01 Conector Google Drive Calendar Gmail"
tipo: "engenharia_de_prompt_n8n"
area: "n8n, automação, CKOS"
status: "draft"
json_workflow: "./01_Conector_Google_Drive_Calendar_Gmail.json"
relacionado:
  - "../../../00_DigitalOcean_PMO/01_Decisao_PMO_Iniciar_com_DigitalOcean.md"
  - "../../../03_Policies/02_Policy_N8N_Prototipo_para_Codigo.md"
---

# 01 Conector Google Drive Calendar Gmail

## Objetivo

Fluxo conceitual para registrar conexão Google por projeto e escopos.
...
```json
{
  ...
  "workflow": "01_Conector_Google_Drive_Calendar_Gmail",
  "project_id": "uuid",
  "result": {},
  "audit_log_id": "uuid"
}
...
Ver arquivo: `01_Conector_Google_Drive_Calendar_Gmail.json`

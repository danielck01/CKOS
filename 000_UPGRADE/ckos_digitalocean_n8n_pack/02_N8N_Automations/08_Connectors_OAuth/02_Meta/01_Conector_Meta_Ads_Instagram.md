---
title: "01 Conector Meta Ads Instagram"
tipo: "engenharia_de_prompt_n8n"
area: "n8n, automação, CKOS"
status: "draft"
json_workflow: "./01_Conector_Meta_Ads_Instagram.json"
relacionado:
  - "../../../00_DigitalOcean_PMO/01_Decisao_PMO_Iniciar_com_DigitalOcean.md"
  - "../../../03_Policies/02_Policy_N8N_Prototipo_para_Codigo.md"
---

# 01 Conector Meta Ads Instagram

## Objetivo

Fluxo conceitual para conectar Meta Ads/Instagram e registrar permissões.
...
```json
{
  ...
  "workflow": "01_Conector_Meta_Ads_Instagram",
  "project_id": "uuid",
  "result": {},
  "audit_log_id": "uuid"
}
...
Ver arquivo: `01_Conector_Meta_Ads_Instagram.json`

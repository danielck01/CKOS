---
title: "01 Sync Google Drive para Knowledge"
tipo: "engenharia_de_prompt_n8n"
area: "n8n, automação, CKOS"
status: "draft"
json_workflow: "./01_Sync_Google_Drive_para_Knowledge.json"
relacionado:
  - "../../../00_DigitalOcean_PMO/01_Decisao_PMO_Iniciar_com_DigitalOcean.md"
  - "../../../03_Policies/02_Policy_N8N_Prototipo_para_Codigo.md"
---

# 01 Sync Google Drive para Knowledge

## Objetivo

Sincronizar novos arquivos do Google Drive para Knowledge.
...
```json
{
  ...
  "workflow": "01_Sync_Google_Drive_para_Knowledge",
  "project_id": "uuid",
  "result": {},
  "audit_log_id": "uuid"
}
...
Ver arquivo: `01_Sync_Google_Drive_para_Knowledge.json`

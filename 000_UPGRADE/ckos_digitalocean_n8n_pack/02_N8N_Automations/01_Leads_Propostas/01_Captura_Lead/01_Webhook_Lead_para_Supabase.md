---
title: "01 Webhook Lead para Supabase"
tipo: "engenharia_de_prompt_n8n"
area: "n8n, automação, CKOS"
status: "draft"
json_workflow: "./01_Webhook_Lead_para_Supabase.json"
relacionado:
  - "../../../00_DigitalOcean_PMO/01_Decisao_PMO_Iniciar_com_DigitalOcean.md"
  - "../../../03_Policies/02_Policy_N8N_Prototipo_para_Codigo.md"
---

# 01 Webhook Lead para Supabase

## Objetivo

Receber lead via webhook, validar campos, salvar no Supabase e notificar equipe.
...
```json
{
  ...
  "workflow": "01_Webhook_Lead_para_Supabase",
  "project_id": "uuid",
  "result": {},
  "audit_log_id": "uuid"
}
...
Ver arquivo: `01_Webhook_Lead_para_Supabase.json`

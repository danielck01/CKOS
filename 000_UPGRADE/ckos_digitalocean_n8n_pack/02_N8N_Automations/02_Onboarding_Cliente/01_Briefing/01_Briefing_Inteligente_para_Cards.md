---
title: "01 Briefing Inteligente para Cards"
tipo: "engenharia_de_prompt_n8n"
area: "n8n, automação, CKOS"
status: "draft"
json_workflow: "./01_Briefing_Inteligente_para_Cards.json"
relacionado:
  - "../../../00_DigitalOcean_PMO/01_Decisao_PMO_Iniciar_com_DigitalOcean.md"
  - "../../../03_Policies/02_Policy_N8N_Prototipo_para_Codigo.md"
---

# 01 Briefing Inteligente para Cards

## Objetivo

Converter respostas de briefing em cards estruturados de projeto.
...
```json
{
  ...
  "workflow": "01_Briefing_Inteligente_para_Cards",
  "project_id": "uuid",
  "result": {},
  "audit_log_id": "uuid"
}
...
Ver arquivo: `01_Briefing_Inteligente_para_Cards.json`

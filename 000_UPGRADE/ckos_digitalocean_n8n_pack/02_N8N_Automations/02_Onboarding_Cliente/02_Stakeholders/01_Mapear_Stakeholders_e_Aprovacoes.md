---
title: "01 Mapear Stakeholders e Aprovacoes"
tipo: "engenharia_de_prompt_n8n"
area: "n8n, automação, CKOS"
status: "draft"
json_workflow: "./01_Mapear_Stakeholders_e_Aprovacoes.json"
relacionado:
  - "../../../00_DigitalOcean_PMO/01_Decisao_PMO_Iniciar_com_DigitalOcean.md"
  - "../../../03_Policies/02_Policy_N8N_Prototipo_para_Codigo.md"
---

# 01 Mapear Stakeholders e Aprovacoes

## Objetivo

Extrair stakeholders, papéis e gates de aprovação.
...
```json
{
  ...
  "workflow": "01_Mapear_Stakeholders_e_Aprovacoes",
  "project_id": "uuid",
  "result": {},
  "audit_log_id": "uuid"
}
...
Ver arquivo: `01_Mapear_Stakeholders_e_Aprovacoes.json`

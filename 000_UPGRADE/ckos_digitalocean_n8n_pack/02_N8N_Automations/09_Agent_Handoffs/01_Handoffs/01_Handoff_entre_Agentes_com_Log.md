---
title: "01 Handoff entre Agentes com Log"
tipo: "engenharia_de_prompt_n8n"
area: "n8n, automação, CKOS"
status: "draft"
json_workflow: "./01_Handoff_entre_Agentes_com_Log.json"
relacionado:
  - "../../../00_DigitalOcean_PMO/01_Decisao_PMO_Iniciar_com_DigitalOcean.md"
  - "../../../03_Policies/02_Policy_N8N_Prototipo_para_Codigo.md"
---

# 01 Handoff entre Agentes com Log

## Objetivo

Registrar handoff entre agentes, motivo, contexto, bloqueio e próximo passo.
...
```json
{
  ...
  "workflow": "01_Handoff_entre_Agentes_com_Log",
  "project_id": "uuid",
  "result": {},
  "audit_log_id": "uuid"
}
...
Ver arquivo: `01_Handoff_entre_Agentes_com_Log.json`

---
title: "01 Ticket Suporte com Contexto do Projeto"
tipo: "engenharia_de_prompt_n8n"
area: "n8n, automação, CKOS"
status: "draft"
json_workflow: "./01_Ticket_Suporte_com_Contexto_do_Projeto.json"
relacionado:
  - "../../../00_DigitalOcean_PMO/01_Decisao_PMO_Iniciar_com_DigitalOcean.md"
  - "../../../03_Policies/02_Policy_N8N_Prototipo_para_Codigo.md"
---

# 01 Ticket Suporte com Contexto do Projeto

## Objetivo

Criar ticket com contexto, projeto, prioridade e sugestão da IA.
...
```json
{
  ...
  "workflow": "01_Ticket_Suporte_com_Contexto_do_Projeto",
  "project_id": "uuid",
  "result": {},
  "audit_log_id": "uuid"
}
...
Ver arquivo: `01_Ticket_Suporte_com_Contexto_do_Projeto.json`

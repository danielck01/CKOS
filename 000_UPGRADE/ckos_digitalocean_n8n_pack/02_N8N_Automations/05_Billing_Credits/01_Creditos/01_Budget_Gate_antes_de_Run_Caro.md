---
title: "01 Budget Gate antes de Run Caro"
tipo: "engenharia_de_prompt_n8n"
area: "n8n, automação, CKOS"
status: "draft"
json_workflow: "./01_Budget_Gate_antes_de_Run_Caro.json"
relacionado:
  - "../../../00_DigitalOcean_PMO/01_Decisao_PMO_Iniciar_com_DigitalOcean.md"
  - "../../../03_Policies/02_Policy_N8N_Prototipo_para_Codigo.md"
---

# 01 Budget Gate antes de Run Caro

## Objetivo

Bloquear ou pedir aprovação quando execução estimada ultrapassar limite.
...
```json
{
  ...
  "workflow": "01_Budget_Gate_antes_de_Run_Caro",
  "project_id": "uuid",
  "result": {},
  "audit_log_id": "uuid"
}
...
Ver arquivo: `01_Budget_Gate_antes_de_Run_Caro.json`

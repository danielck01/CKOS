---
title: "01 Evento Stripe Atualiza Wallet"
tipo: "engenharia_de_prompt_n8n"
area: "n8n, automação, CKOS"
status: "draft"
json_workflow: "./01_Evento_Stripe_Atualiza_Wallet.json"
relacionado:
  - "../../../00_DigitalOcean_PMO/01_Decisao_PMO_Iniciar_com_DigitalOcean.md"
  - "../../../03_Policies/02_Policy_N8N_Prototipo_para_Codigo.md"
---

# 01 Evento Stripe Atualiza Wallet

## Objetivo

Receber webhook de pagamento e atualizar wallet de créditos.
...
```json
{
  ...
  "workflow": "01_Evento_Stripe_Atualiza_Wallet",
  "project_id": "uuid",
  "result": {},
  "audit_log_id": "uuid"
}
...
Ver arquivo: `01_Evento_Stripe_Atualiza_Wallet.json`

---
title: "01 Gerar Roteiro Reels por Insight"
tipo: "engenharia_de_prompt_n8n"
area: "n8n, automação, CKOS"
status: "draft"
json_workflow: "./01_Gerar_Roteiro_Reels_por_Insight.json"
relacionado:
  - "../../../00_DigitalOcean_PMO/01_Decisao_PMO_Iniciar_com_DigitalOcean.md"
  - "../../../03_Policies/02_Policy_N8N_Prototipo_para_Codigo.md"
---

# 01 Gerar Roteiro Reels por Insight

## Objetivo

Gerar roteiro de Reels a partir de insight aprovado.
...
```json
{
  ...
  "workflow": "01_Gerar_Roteiro_Reels_por_Insight",
  "project_id": "uuid",
  "result": {},
  "audit_log_id": "uuid"
}
...
Ver arquivo: `01_Gerar_Roteiro_Reels_por_Insight.json`

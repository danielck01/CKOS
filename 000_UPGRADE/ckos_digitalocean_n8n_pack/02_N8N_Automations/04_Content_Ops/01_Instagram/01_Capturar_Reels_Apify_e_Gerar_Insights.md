---
title: "01 Capturar Reels Apify e Gerar Insights"
tipo: "engenharia_de_prompt_n8n"
area: "n8n, automação, CKOS"
status: "draft"
json_workflow: "./01_Capturar_Reels_Apify_e_Gerar_Insights.json"
relacionado:
  - "../../../00_DigitalOcean_PMO/01_Decisao_PMO_Iniciar_com_DigitalOcean.md"
  - "../../../03_Policies/02_Policy_N8N_Prototipo_para_Codigo.md"
---

# 01 Capturar Reels Apify e Gerar Insights

## Objetivo

Executar actor Apify de Instagram/Reels e salvar insights para agentes.
...
```json
{
  ...
  "workflow": "01_Capturar_Reels_Apify_e_Gerar_Insights",
  "project_id": "uuid",
  "result": {},
  "audit_log_id": "uuid"
}
...
Ver arquivo: `01_Capturar_Reels_Apify_e_Gerar_Insights.json`

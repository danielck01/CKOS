---
title: Learning, Study & Memory Roadmap — ck_risks
file: ck_risks.md
phase: 000_ROADMAPS
...
related_notes:
  - README.md
tags: [risks, governance, 08_learning_study_memory_roadmap]
---

# ck_risks — Learning, Study & Memory Roadmap

| ID | Risco | Severidade | Sinal | Mitigação | Status |
|---|---|---:|---|---|---|
| R-08_LEARNING_STUDY_MEMORY_ROADMAP-001 | Criar documentação duplicada | Alta | Novo doc sem consultar mapa | Ler CKOS_FILETREE_MAP e ck_memory | aberto |
| R-08_LEARNING_STUDY_MEMORY_ROADMAP-002 | Implementar antes da hora | Alta | Pedido visual vira código | Aplicar prompt DO_NOT_IMPLEMENT | aberto |
| R-08_LEARNING_STUDY_MEMORY_ROADMAP-003 | Perder governança de versões | Média | YAML inconsistente | Usar template CKOS | aberto |
| R-08_LEARNING_STUDY_MEMORY_ROADMAP-004 | Agentes editarem mesmo arquivo | Alta | Dois chats na mesma pasta | CHECKOUT_LOCK + handoff | aberto |
| R-08_LEARNING_STUDY_MEMORY_ROADMAP-005 | Confundir estudo com canônico | Alta | Study note vira regra final | RAW → STUDY → CANONICAL | aberto |

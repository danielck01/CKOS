...
related_notes:
  - README.md
tags: [roadmap, 02_runtime_backend_roadmap, readme]
---
...
Planeja backend, event bus, persistence, policy engine, cost guard, approval gates e observabilidade sem implementar ainda.

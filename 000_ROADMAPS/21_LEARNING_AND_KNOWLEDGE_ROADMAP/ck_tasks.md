---
title: "Learning and Knowledge Roadmap - Tasks"
system_id: roadmap_21_learning_and_knowledge_ck_tasks
layer: auxiliary
phase: 000_ROADMAPS
category: roadmap
status: draft
...
purpose: "Track approved and pending tasks for the learning and knowledge auxiliary roadmap."
inputs:
...
tags:
  ...
  - "ck_tasks"
---
# Learning and Knowledge Roadmap - Tasks

## Backlog

- task_id: 21_LEARNING_AND_KNOWLEDGE_P2_EXPAND_SCOPE
...
- task_id: 21_LEARNING_AND_KNOWLEDGE_P1_PMO_REVIEW
  owner_session: pmo_ckos
  status: ready
...
- task_id: 21_LEARNING_AND_KNOWLEDGE_P1_STRUCTURE_CREATED
...
- task_id: 21_LEARNING_AND_KNOWLEDGE_P1_CREATE_FOLDER
  owner_session: ceo_agent_ckos
  status: done
...
- task_id: 21_LEARNING_AND_KNOWLEDGE_IMPLEMENTATION
  owner_session: none
  status: blocked

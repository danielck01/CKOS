---
title: Client Project Creator Mode Roadmap — README
file: README.md
phase: 000_ROADMAPS
...
related_notes:
  - README.md
tags: [roadmap, 09_client_project_creator_mode_roadmap, readme]
---

# Client Project Creator Mode Roadmap

## Propósito

Planeja criação de projetos por intenção mínima, briefing inteligente, filetree proposal, execução simulada e aprovação Founder.

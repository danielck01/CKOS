---
title: Youtube Reference Collector
folder: 09_RESEARCH_AND_COLLECTION_SYSTEM
type: documentation
status: draft
owner: CKOS PMO
agents:
...
# Youtube Reference Collector

## 1. Resumo
Nota operacional da pasta 09_RESEARCH_AND_COLLECTION_SYSTEM, criada para orientar Claude, Codex, superagents, agents e subagents na arquitetura backend-first do DNA_system.

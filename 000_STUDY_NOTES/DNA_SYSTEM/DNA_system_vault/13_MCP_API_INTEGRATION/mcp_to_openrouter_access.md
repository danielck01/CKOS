---
title: Mcp To Openrouter Access
folder: 13_MCP_API_INTEGRATION
type: documentation
status: draft
owner: CKOS PMO
agents:
...
# Mcp To Openrouter Access

## 1. Resumo
Nota operacional da pasta 13_MCP_API_INTEGRATION, criada para orientar Claude, Codex, superagents, agents e subagents na arquitetura backend-first do DNA_system.

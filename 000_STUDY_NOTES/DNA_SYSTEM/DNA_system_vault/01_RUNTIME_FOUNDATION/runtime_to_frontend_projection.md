---
title: Runtime To Frontend Projection
folder: 01_RUNTIME_FOUNDATION
type: documentation
status: draft
owner: CKOS PMO
agents:
...
# Runtime To Frontend Projection

## 1. Resumo
Nota operacional da pasta 01_RUNTIME_FOUNDATION, criada para orientar Claude, Codex, superagents, agents e subagents na arquitetura backend-first do DNA_system.

---
title: Study Mode Context Protocol
...
# Study Mode Context Protocol

## 1. Resumo
Nota operacional da pasta 05_CONTEXT_ENGINE, criada para orientar Claude, Codex, superagents, agents e subagents na arquitetura backend-first do DNA_system.

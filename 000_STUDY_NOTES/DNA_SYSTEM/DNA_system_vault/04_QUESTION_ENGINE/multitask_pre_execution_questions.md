---
title: Multitask Pre Execution Questions
folder: 04_QUESTION_ENGINE
type: documentation
status: draft
owner: CKOS PMO
agents:
...
# Multitask Pre Execution Questions

## 1. Resumo
Nota operacional da pasta 04_QUESTION_ENGINE, criada para orientar Claude, Codex, superagents, agents e subagents na arquitetura backend-first do DNA_system.

---
title: Research To Campaign Opportunities
folder: 18_TRANSFORMERS
type: documentation
status: draft
owner: CKOS PMO
agents:
...
# Research To Campaign Opportunities

## 1. Resumo
Nota operacional da pasta 18_TRANSFORMERS, criada para orientar Claude, Codex, superagents, agents e subagents na arquitetura backend-first do DNA_system.

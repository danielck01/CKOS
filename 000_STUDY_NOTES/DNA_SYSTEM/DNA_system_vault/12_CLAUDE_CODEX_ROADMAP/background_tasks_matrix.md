---
title: Background Tasks Matrix
folder: 12_CLAUDE_CODEX_ROADMAP
type: documentation
status: draft
owner: CKOS PMO
agents:
...
# Background Tasks Matrix

## 1. Resumo
Define a operação simultânea entre Claude e Codex em study mode, com ownership por pasta, handoff assíncrono, locks, perguntas obrigatórias, sync reviews e definição de pronto.

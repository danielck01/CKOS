---
title: Creative Dna To Workflow Rules
folder: 06_CREATIVE_DNA_CORE
type: documentation
status: draft
owner: CKOS PMO
agents:
...
# Creative Dna To Workflow Rules

## 1. Resumo
Nota operacional da pasta 06_CREATIVE_DNA_CORE, criada para orientar Claude, Codex, superagents, agents e subagents na arquitetura backend-first do DNA_system.

...
## 1. Resumo
Nota operacional da pasta 00_GOVERNANCE, criada para orientar Claude, Codex, superagents, agents e subagents na arquitetura backend-first do DNA_system.

...
# No Project No Workflow

## 1. Resumo
Nota operacional da pasta 02_PROJECT_RESOLUTION, criada para orientar Claude, Codex, superagents, agents e subagents na arquitetura backend-first do DNA_system.
